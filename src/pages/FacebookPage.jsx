...
import '../styles/FacebookPage.css';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
              <a href="tel:+919754015503" className="flex items-center justify-center gap-2 text-white hover:text-blue-200 transition-colors">
                <Phone size={16} />
                +91 97540 15503
              </a>
