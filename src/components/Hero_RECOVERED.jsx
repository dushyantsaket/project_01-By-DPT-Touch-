...
const Hero = () => {
  return (
    <section id="home" className="hero-section">
      {/* ΓöÇΓöÇ Video background ΓöÇΓöÇ */}
      <video
      ...
      {/* ΓöÇΓöÇ Very light vignette so text stays readable ΓöÇΓöÇ */}
      <div className="hero-overlay" />

      {/* ΓöÇΓöÇ Content anchored at bottom-left ΓöÇΓöÇ */}
      <div className="hero-content">
        ...
        <p className="hero-desc">
          Heavy-duty tools, premium spare parts &amp; diamond blades ΓÇö
      ...
      {/* ΓöÇΓöÇ Stats strip ΓÇö right side ΓöÇΓöÇ */}
      ...
      <style>{`
        ...
        /* *** KEY CHANGE ΓÇö very light overlay so video shines *** */
        .hero-overlay {
          position: absolute;
          inset: 0;
          z-index: 1;
