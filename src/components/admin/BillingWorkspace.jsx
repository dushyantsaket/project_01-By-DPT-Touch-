...
//     notes: "",
//     terms:
//       "Goods once sold will not be taken back or exchanged.\nAll disputes are subject to [ENTER YOUR CITY, NAME] jurisdiction only.",
//     signature: "",
//   });
...
//             }}
//           >
//             <FileText size={24} /> Create {typeLabel} Invoice
//           </h2>
...
//               }}
//             >
//               <UploadCloud size={16} /> Upload using Phone
//             </button>
//             <button
//               style={{
//                 padding: "6px 12px",
...
//                 <label style={{ fontWeight: "500" }}>+ Add Notes</label>
//                 <textarea
...
//         }}
//       >
//         {["all", "sales", "purchases", "dealer"].map((tab) => (
//           <button
//             key={tab}
...
//                 }}
//               >
//                 {invoices.filter((inv) => inv.type === tab).length}
//               </span>
//             )}
//           </button>
//         ))}
...
//       const discounted = total - (total * disc) / 100;
//       const taxAmount = (discounted * tax) / 100;
...
//               <Settings size={20} />
//             </button>
//             <button style={styles.btnSecondary}>Save & New</button>
...
//           </div>
//           <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
//             <button style={styles.btnSmallPrimary}>Change Settings</button>
...
//                 Bill From
//               </div>
//               <div style={styles.addPartyPlaceholder}>
//                 <User size={20} /> + Add Party
//               </div>
//             </div>
...
//                   <Plus size={16} /> Add Item
//                 </button>
//                 <button type="button" style={styles.btnScan}>
//                   <Scan size={16} /> Scan Barcode
//                 </button>
//               </div>
//             </div>
...
//                           value={row.unit}
//                           onChange={(e) =>
//                             updateItemRow(row.id, "unit", e.target.value)
//                           }
//                           placeholder="Unit"
//                           style={styles.inputTiny}
//                         />
...
//                 <span>₹{formData.previousBalance.toFixed(2)}</span>
//               </div>
//               <div style={styles.totalsRowItem}>
...
//                 <div style={styles.signaturePlaceholder}>+ Add Signature</div>
//               </div>
//             </div>
//           </div>
//         </form>
...
// // ----------------------------
// // 2. INVOICE PRINT SETTINGS & PREVIEW
// // ----------------------------
...
//   showToast,
// }) => {
//   const [paperSize, setPaperSize] = useState("3"); // 2,3,4,5,6 inch
//   const [theme, setTheme] = useState("compact"); // compact, advanced, simple, classic
...
//   const [autoApplyLuxury, setAutoApplyLuxury] = useState(false);
...
//   // Print the invoice using window.print or react-to-print
//   const handlePrint = () => {
//     // In a real app, you would trigger print using a library or iframe
//     showToast("Print triggered (implement with react-to-print)");
//   };

//   return (
//     <div style={styles.printSettingsContainer}>
//       <h3 style={{ marginBottom: "20px" }}>Print Settings</h3>
//       <div style={styles.twoColumn}>
//         {/* Left: Settings */}
...
//             <h4>Themes</h4>
//             <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
//               {["compact", "advanced", "simple", "classic"].map((t) => (
//                 <button
//                   key={t}
//                   onClick={() => setTheme(t)}
//                   style={{
//                     padding: "6px 16px",
//                     background: theme === t ? "#2563eb" : "#f1f5f9",
//                     color: theme === t ? "#fff" : "#1e293b",
//                     border: "none",
//                     borderRadius: "20px",
//                     cursor: "pointer",
//                     textTransform: "capitalize",
...
//                 onChange={(e) => setShowAlternateUnit(e.target.checked)}
//               />{" "}
//               Show alternate unit in invoice
//             </label>
//             <label style={{ display: "block", margin: "6px 0" }}>
//               <input
//                 type="checkbox"
...
//                 onChange={(e) => setAutoApplyLuxury(e.target.checked)}
//               />{" "}
//               Auto-apply luxury theme for sharing
//             </label>
//           </div>
...
//               <label>
//                 <input type="checkbox" defaultChecked /> Party Details
//               </label>
//               <label>
//                 <input type="checkbox" defaultChecked /> Item Table Columns
//               </label>
//               <label>
//                 <input type="checkbox" defaultChecked /> Miscellaneous Details
//               </label>
//             </div>
//           </div>
...
//             {/* Invoice preview will use the actual invoice data and theme */}
//             <InvoicePreview
...
//       style={{
//         ...themeStyles[theme],
//         width: paperWidth[paperSize] || "100%",
//         maxWidth: "100%",
//         background: "#fff",
//         margin: "0 auto",
//         overflow: "auto",
...
//           <strong>Bill To:</strong> {invoiceData?.party?.name || "Party Name"}
//         </div>
//         <div style={{ marginTop: "8px", fontSize: "12px" }}>
//           <strong>Items:</strong>
//         </div>
...
//           <strong>Total: </strong> ₹{invoiceData?.grandTotal || 0}
//         </div>
//         {settings?.showPartyBalance && (
//           <div style={{ fontSize: "12px" }}>
//             Party Balance: ₹{invoiceData?.partyBalance || 0}
//           </div>
//         )}
//         {settings?.showTime && (
//           <div style={{ fontSize: "12px" }}>
...
//           Terms: {invoiceData?.terms || "Standard terms apply"}
//         </div>
//       </div>
//     </div>
//   );
...
//           </div>
//           <div>
//             <label style={styles.label}>Enable e-Invoicing</label>
//             <input
//               type="checkbox"
//               name="enableEInvoice"
...
//   const themes = [
//     { id: "modern", label: "Modern", icon: <Layout size={20} /> },
//     { id: "luxury", label: "Luxury", icon: <Moon size={20} /> },
//     { id: "stylish", label: "Stylish", icon: <Sun size={20} /> },
...
//         <h4>Theme Settings</h4>
//         <label style={{ display: "block", margin: "6px 0" }}>
//           <input type="checkbox" /> Show party balance in invoice
//         </label>
//         <label style={{ display: "block", margin: "6px 0" }}>
//           <input type="checkbox" /> Enable free item quantity
//         </label>
//         <label style={{ display: "block", margin: "6px 0" }}>
//           <input type="checkbox" /> Show item description in invoice
//         </label>
//         <label style={{ display: "block", margin: "6px 0" }}>
//           <input type="checkbox" /> Show alternate unit in invoice
//         </label>
//         <label style={{ display: "block", margin: "6px 0" }}>
//           <input type="checkbox" /> Show phone number on invoice
//         </label>
//         <label style={{ display: "block", margin: "6px 0" }}>
//           <input type="checkbox" /> Show time on invoices
//         </label>
//         <label style={{ display: "block", margin: "6px 0" }}>
//           <input type="checkbox" /> Price History
//         </label>
//         <label style={{ display: "block", margin: "6px 0" }}>
//           <input type="checkbox" /> Auto-apply luxury theme for sharing
//         </label>
//       </div>
//     </div>
//   );
...
// // ----------------------------
// // 6. MAIN BILLING WORKSPACE
// // ----------------------------
// export default function BillingWorkspace({ token, showToast }) {
//   // State
//   const [activeTab, setActiveTab] = useState("invoices"); // invoices | print | business | templates
//   const [invoices, setInvoices] = useState([]);
//   const [loading, setLoading] = useState(true);
//   const [searchTerm, setSearchTerm] = useState("");
//   const [showModal, setShowModal] = useState(false);
...
//                           </button>
//                           <button
//                             onClick={() => showToast("PDF download")}
//                             style={styles.actionBtn}
//                           >
//                             <Download size={16} />
//                           </button>
...
//               <p>No parties found. Add a new party first.</p>
//             </div>
//           ) : (
//             filtered.map((party) => (
//               <div
...
//   // ---------- Party Selector Modal with Add Party ----------
//   const PartySelector = ({ onSelect, onClose, showToast, token }) => {
//     const [parties, setParties] = useState([]);
//     const [searchTerm, setSearchTerm] = useState("");
//     const [loading, setLoading] = useState(true);
...
//           // Optionally auto-select the new party
//           onSelect(data.data);
//         } else {
//           const err = await res.json();
...
//         );
//         onSave(); // ← यह fetchInvoices को ट्रिगर करेगा
